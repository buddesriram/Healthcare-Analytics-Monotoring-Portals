...
# PAGE CONFIG
# ==========================================
st.set_page_config(page_title="Healthcare Analytics Portal", layout="wide")
...
if not st.session_state.logged_in:
    ...
    with st.form("login_form"):
        ...
        phone = st.text_input("Admin Phone").strip()
    ...
    if send_otp:
        if email == ADMIN_EMAIL and phone == ADMIN_PHONE:
            ...
            st.info("OTP valid for 30 seconds")
        else:
